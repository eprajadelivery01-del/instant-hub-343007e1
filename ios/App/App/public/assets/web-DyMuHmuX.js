import{aX as C,aY as M,aZ as ae,a_ as se,a$ as ce,b0 as de,b1 as k,b2 as ue,b3 as fe,b4 as F,b5 as le,b6 as V,b7 as T,aW as pe}from"./index-BvdpyDBz.js";/**
 * @license
 ...
 */const he="/firebase-messaging-sw.js",we="/firebase-cloud-messaging-push-scope",J="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",ge="https://fcmregistrations.googleapis.com/v1",Y="google.c.a.c_id",be="google.c.a.c_l",ye="google.c.a.ts",me="google.c.a.e",K=1e4;var P;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(P||(P={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u(e){const t=new Uint8Array(e);return btoa(String.fromCharCode(...t)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function Q(e){const t="=".repeat((4-e.length%4)%4),n=(e+t).replace(/\-/g,"+").replace(/_/g,"/"),i=atob(n),o=new Uint8Array(i.length);for(let r=0;r<i.length;++r)o[r]=i.charCodeAt(r);return o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j="firebase-messaging-database",H=2,l="firebase-messaging-store",f="firebase-messaging-fid-registration-store",Ie={openDB:V,deleteDB:T};let U=Ie,y=null;function _e(e,t,n){switch(t){case 0:if(e.createObjectStore(l),n===1)break;case 1:n===2&&e.createObjectStore(f)}}function L(e){return{upgrade:(t,n)=>{_e(t,n,e)},blocked:()=>{},blocking:(t,n,i)=>{var o;y=null,(o=i.target)==null||o.close()},terminated:()=>{y=null}}}function w(){return y||(y=U.openDB(j,H,L(2)).catch(()=>U.openDB(j,H-1,L(1)))),y}function z(e,t){return e.objectStoreNames.contains(t)}function R(e){if(!z(e,f))throw c.create("fid-registration-idb-schema-unavailable")}async function X(e){const t=g(e),i=await(await w()).transaction(l).objectStore(l).get(t);if(i)return i;{const o=await Te(e.appConfig.senderId);if(o)return await D(e,o),o}}async function D(e,t){const n=g(e),i=await w(),o=[l],r=z(i,f);r&&o.push(f);const a=i.transaction(o,"readwrite");return await a.objectStore(l).put(t,n),r&&await a.objectStore(f).delete(n),await a.done,t}async function Ee(e){const t=g(e),i=(await w()).transaction(l,"readwrite");await i.objectStore(l).delete(t),await i.done}async function A(e){const t=g(e),n=await w();return R(n),await n.transaction(f).objectStore(f).get(t)}async function Re(e,t){const n=g(e),i=await w();R(i);const o=i.transaction([l,f],"readwrite");return await o.objectStore(f).put(t,n),await o.objectStore(l).delete(n),await o.done,t}async function De(e){const t=g(e),n=await w();R(n);const i=n.transaction(f,"readwrite");await i.objectStore(f).delete(t),await i.done}function g({appConfig:e}){return e.appId}const B="@firebase/messaging",E="0.13.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const He=7*24*60*60*1e3;async function Ue(e){const t=await Ge(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:u(t.getKey("auth")),p256dh:u(t.getKey("p256dh"))},i=await X(e.firebaseDependencies);if(i){if(qe(i.subscriptionOptions,n))return Date.now()>=i.createTime+He?$e(e,{token:i.token,createTime:Date.now(),subscriptionOptions:n}):i.token;try{await Z(e.firebaseDependencies,i.token)}catch(o){console.warn(o)}return $(e.firebaseDependencies,n)}else return $(e.firebaseDependencies,n)}async function Le(e,t){await Z(e.firebaseDependencies,t.token),await Ee(e.firebaseDependencies),await ee(e.firebaseDependencies)}async function Be(e){const t=await A(e.firebaseDependencies).catch(()=>{}),n=t==null?void 0:t.fid;n&&await Me(e.firebaseDependencies,n),await ee(e.firebaseDependencies),n&&Je(e,n)}async function We(e){const t=await X(e.firebaseDependencies);t?await Le(e,t):await Be(e);const n=await e.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function $e(e,t){try{const n=await Pe(e.firebaseDependencies,t),i={...t,token:n,createTime:Date.now()};return await D(e.firebaseDependencies,i),n}catch(n){throw n}}async function $(e,t){const i={token:await Oe(e,t),createTime:Date.now(),subscriptionOptions:t};return await D(e,i),i.token}async function Ge(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Q(t)})}function qe(e,t){const n=t.vapidKey===e.vapidKey,i=t.endpoint===e.endpoint,o=t.auth===e.auth,r=t.p256dh===e.p256dh;return n&&i&&o&&r}async function ee(e){try{await De(e)}catch{}}function Ve(e,t){const n=e.onRegisteredHandler;n&&(typeof n=="function"?n(t):n.next(t))}function Je(e,t){const n=e.onUnregisteredHandler;n&&(typeof n=="function"?n(t):n.next(t))}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function te(e){try{e.swRegistration=await navigator.serviceWorker.register(he,{scope:we}),e.swRegistration.update().catch(()=>{}),await Ye(e.swRegistration)}catch(t){throw c.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}async function Ye(e){return new Promise((t,n)=>{const i=setTimeout(()=>n(new Error(`Service worker not registered after ${K} ms`)),K),o=e.installing||e.waiting;e.active?(clearTimeout(i),t()):o?o.onstatechange=r=>{var a;((a=r.target)==null?void 0:a.state)==="activated"&&(o.onstatechange=null,clearTimeout(i),t())}:(clearTimeout(i),n(new Error("No incoming service worker found.")))})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ze(e,t){return le(t,()=>{(async()=>!e.onRegisteredHandler||!await A(e.firebaseDependencies)||await oe(e).catch(()=>{}))()})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function it(e){return typeof e=="object"&&!!e&&Y in e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function re(e,t){if(!navigator)throw c.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw c.create("permission-blocked");return await ie(e,t==null?void 0:t.vapidKey),await ne(e,t==null?void 0:t.serviceWorkerRegistration),Ue(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function at(e,t,n){const i=st(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[Y],message_name:n[be],message_time:n[ye],message_device_time:Math.floor(Date.now()/1e3)})}function st(e){switch(e){case h.NOTIFICATION_CLICKED:return"notification_open";case h.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ct(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;if(e.onMessageHandler&&n.messageType===h.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(q(n)):e.onMessageHandler.next(q(n))),e.onRegisteredHandler&&n.messageType===h.FID_REGISTERED){const o=n.fid;typeof e.onRegisteredHandler=="function"?e.onRegisteredHandler(o):e.onRegisteredHandler.next(o)}const i=n.data;it(i)&&i[me]==="1"&&await at(e,n.messageType,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _(e=ue()){return b().then(t=>{if(!t)throw c.create("unsupported-browser")},t=>{throw c.create("indexed-db-unsupported")}),de(k(e),"messaging").getImmediate()}async function ht(e,t){return e=k(e),re(e,t)}function wt(e){return e=k(e),lt(e)}function gt(e,t){return e=k(e),pt(e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
