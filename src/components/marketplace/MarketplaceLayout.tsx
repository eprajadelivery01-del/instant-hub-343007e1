    ...
    <div className="app-shell min-h-screen flex flex-col font-sans text-foreground bg-slate-50/30">
      ...
      <main className={cn(
        ...
        <footer className="mt-auto flex w-full flex-col items-center justify-center py-12 border-t border-border/50 bg-white">
          <p className="text-[11px] font-black tracking-widest text-muted-foreground opacity-60 mb-2">É Pra Já Delivery</p>
          <p className="text-[10px] font-medium text-muted-foreground/40 mb-2">© 2026 • Todos os direitos reservados</p>
          <p className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground opacity-30">BONASOFT</p>
        </footer>
      </main>
